...
async def stats(_, message):
    ...
    system_info = f'''<u><b>Sʏꜱᴛᴇᴍ Sᴛᴀᴛꜱ 🧮</b></u>\n
                  ...
                  <b>Used:</b> {psutil._common.bytes2human(disk.used)}B | <b>Free:</b> {psutil._common.bytes2human(disk.free)}B\n\n
                  <b>🔺 Total Upload:</b> {psutil._common.bytes2human(ul_size)}B\n
                  <b>🔻 Total Download:</b> {psutil._common.bytes2human(dl_size)}B\n\n
                  <b>🎮 Total Ram Space:</b> {psutil._common.bytes2human(ram_stats.total)}B\n

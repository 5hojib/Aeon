...
from bot.helper.ext_utils.files_utils import get_base_name, get_path_size, clean_download, split_file, prepare_file, clean_target, is_first_archive_split, is_archive, is_archive_split, join_files
...
class MirrorLeechListener:
    ...
    async def onUploadComplete(self, link, size, files, folders, mime_type, name, rclonePath=''):
        ...
        name, _ = await prepare_file(name, user_id, isMirror=not self.isLeech)

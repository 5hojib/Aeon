...
from bot.helper.ext_utils.bot_utils import get_content_type, is_telegram_link, is_gdrive_link, is_magnet, is_mega_link, is_rclone_path, is_url, new_task, sync_to_async

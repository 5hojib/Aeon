...
class Filter:
    async def __call__(self, client: "telegram.Client", update: Update):
...
"""Filter messages that contain :obj:`~telegram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~telegram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~telegram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~telegram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~telegram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~telegram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~telegram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~telegram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~telegram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~telegram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~telegram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~telegram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~telegram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~telegram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~telegram.types.Message`.
    ...
    async def func(flt, client: telegram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~telegram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~telegram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~telegram.types.InlineQuery`: The filter will match ``query``.

...
import telegram
from telegram import __version__, __license__
from telegram import enums
from telegram import raw
from telegram import utils
from telegram.crypto import aes
from telegram.errors import CDNFileHashMismatch
from telegram.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from telegram.handlers.handler import Handler
from telegram.methods import Methods
from telegram.session import Auth, Session
from telegram.storage import FileStorage, MemoryStorage, MongoStorage, Storage
from telegram.types import User, TermsOfService
from telegram.utils import ainput
...
class Client(Methods):
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~telegram.enums.ParseMode`):
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except telegram.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:

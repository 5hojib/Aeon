...
from telegram.errors import UnknownError
...
class GetInlineBotResults:
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~telegram.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <telegram.api.types.messages.BotResults>`: On Success.

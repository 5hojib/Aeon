...
class Invoke:
    async def invoke(
        ...
        Available functions are listed in the :obj:`functions <telegram.api.functions>` package and may accept compound
        data types from :obj:`types <telegram.api.types>` as well as bare types such as ``int``, ``str``, etc...

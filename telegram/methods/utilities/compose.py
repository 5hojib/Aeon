...
async def compose(
    ...
    If you want to run a single client, you can use Client's bound method :meth:`~telegram.Client.run`.

    Parameters:
        clients (List of :obj:`~telegram.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from telegram import Client, compose

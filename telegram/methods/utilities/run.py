...
import telegram
from telegram.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~telegram.Client.start`, :meth:`~telegram.idle` and :meth:`~telegram.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`telegram.compose`.

...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~telegram.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, telegram.Client):
                self.add_handler(telegram.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        telegram.handlers.DeletedMessagesHandler(func, self),

...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~telegram.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, telegram.Client):
                self.add_handler(telegram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        telegram.handlers.ChosenInlineResultHandler(func, self),

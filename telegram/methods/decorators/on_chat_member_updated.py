...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~telegram.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, telegram.Client):
                self.add_handler(telegram.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        telegram.handlers.ChatMemberUpdatedHandler(func, self),

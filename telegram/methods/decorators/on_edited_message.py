...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~telegram.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, telegram.Client):
                self.add_handler(telegram.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        telegram.handlers.EditedMessageHandler(func, self),

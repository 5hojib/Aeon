...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~telegram.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, telegram.Client):
                self.add_handler(telegram.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        telegram.handlers.UserStatusHandler(func, self),

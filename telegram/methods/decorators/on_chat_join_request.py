...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~telegram.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, telegram.Client):
                self.add_handler(telegram.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        telegram.handlers.ChatJoinRequestHandler(func, self),

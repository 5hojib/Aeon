...
import telegram
from telegram import raw, types, enums
    ...
    async def get_chat_members(
        ...
        Parameters:
            ...
            query (``str``, *optional*):
                ...
                A query string is applicable only for :obj:`~telegram.enums.ChatMembersFilter.SEARCH`,
                :obj:`~telegram.enums.ChatMembersFilter.BANNED` and :obj:`~telegram.enums.ChatMembersFilter.RESTRICTED`
                filters only.

            limit (``int``, *optional*):
                Limits the number of members to be retrieved.

            filter (:obj:`~telegram.enums.ChatMembersFilter`, *optional*):
                Filter used to select the kind of members you want to retrieve. Only applicable for supergroups
                and channels.

        Returns:
            ``Generator``: On success, a generator yielding :obj:`~telegram.types.ChatMember` objects is returned.

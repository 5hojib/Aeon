...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~telegram.types.InputMediaPhoto`, :obj:`~telegram.types.InputMediaVideo`, :obj:`~telegram.types.InputMediaAudio`, :obj:`~telegram.types.InputMediaDocument` and :obj:`~telegram.types.InputMediaAnimation`):
        ...
        Returns:
            List of :obj:`~telegram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from telegram.types import InputMediaPhoto, InputMediaVideo

...
import telegram
from telegram import StopTransmission, enums
from telegram import raw
from telegram import types
from telegram import utils
from telegram.errors import FilePartMissing
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~telegram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~telegram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~telegram.Client.stop_transmission`, None is returned.

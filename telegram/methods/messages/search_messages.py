...
class SearchMessages:
    ...
    async def search_messages(
        ...
        If you want to get the messages count only, see :meth:`~telegram.Client.search_messages_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~telegram.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~telegram.types.Message` objects.

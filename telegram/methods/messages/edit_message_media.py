...
class EditMessageMedia:
    async def edit_message_media(
        ...
        Parameters:
            ...
            media (:obj:`~telegram.types.InputMedia`):
                One of the InputMedia objects describing an animation, audio, document, photo or video.

            reply_markup (:obj:`~telegram.types.InlineKeyboardMarkup`, *optional*):
        ...
        Returns:
            :obj:`~telegram.types.Message`: On success, the edited message is returned.

        Example:
            .. code-block:: python

                from telegram.types import InputMediaPhoto, InputMediaVideo, InputMediaAudio

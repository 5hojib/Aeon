...
from telegram import types, enums
...
class SendPoll:
    async def send_poll(
        ...
        Parameters:
            ...
            type (:obj`~telegram.enums.PollType`, *optional*):
                Poll type, :obj:`~telegram.enums.PollType.QUIZ` or :obj:`~telegram.enums.PollType.REGULAR`.
                Defaults to :obj:`~telegram.enums.PollType.REGULAR`.
            ...
            explanation_parse_mode (:obj:`~telegram.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            explanation_entities (List of :obj:`~telegram.types.MessageEntity`):
        ...
        Returns:
            :obj:`~telegram.types.Message`: On success, the sent poll message is returned.

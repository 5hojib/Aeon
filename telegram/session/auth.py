...
from telegram.connection import Connection
from telegram.crypto import aes, rsa, prime
from telegram.errors import SecurityCheckMismatch
from telegram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "telegram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id

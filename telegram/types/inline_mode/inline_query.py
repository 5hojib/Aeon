...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        from_user (:obj:`~telegram.types.User`):
            Sender.
        ...
        chat_type (:obj:`~telegram.enums.ChatType`, *optional*):
            Type of the chat, from which the inline query was sent.

        location (:obj:`~telegram.types.Location`. *optional*):
            Sender location, only for bots that request user location.

        matches (List of regex Matches, *optional*):
            A list containing all `Match Objects <https://docs.python.org/3/library/re.html#match-objects>`_ that match
            the query of this inline query. Only applicable when using :obj:`Filters.regex <telegram.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~telegram.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~telegram.types.InlineQueryResult`):
